...
public class AdvertisementController {
    ...
    public String getUsersByUserName(Map<String, Object> model, @PathVariable(value = "name") String name, String surname) {
        model.put("userList", userService.getUserListByUserName(name, surname));
        return "userui";
    }
